            ...
            if(args.length > 0) {
                ...
                if (subCommands.containsKey(subCommand)) {
                    ...
                    if (command.canUser(sender)) {
                        ...
                        sender.sendMessage(lang.translateString(main.msgPrefix +"command_not_permission"));
                    }else {
                        sender.sendMessage(lang.translateString(main.msgPrefix +"command_in_game_run"));
                    }
                }else {
